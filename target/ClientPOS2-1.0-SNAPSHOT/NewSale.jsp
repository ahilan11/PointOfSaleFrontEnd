...
<div class="navbar">
  ...
  <a href="RegisterStore.jsp"><i class="fa fa-industry" aria-hidden="true" style="color:#ff99cc"></i>REGISTER STORE</a>
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-size: 24px; color: #660066;">SALE</span></p></div>
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><em><span style="font-size: 14px;">You can either enter the ID of the product you are looking for or place the barcode to the product to the camera to be scanned</span></em></p></div>
        ...
        <tbody>
          <tr>
            <td>
                ...
                <%Iterator<Map.Entry<Product, String>> itr = map.entrySet().iterator();%>
          
        <%while(itr.hasNext()){%>
            <% Map.Entry<Product, String> entry = itr.next();%>
            <p>Product: <%=entry.getKey().getId()%>   <%=entry.getKey().getName()%>     <%=entry.getKey().getPrice()%>  </p><br>
...
<div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-size: 14px;">
      ...
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
        <tr>
          <td align="center" bgcolor="#7ED321" role="presentation" style="border:none;border-radius:24px;cursor:auto;mso-padding-alt:9px 26px 9px 26px;background:#ff99cc;" valign="middle">
              <form action="SaleController" method="post">
