...
@import url(https://fonts.googleapis.com/css?family=Cabin:400,700);
    ...
    <style type="text/css">
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial;font-size:14px;line-height:1.5;text-align:center;color:#c3c3c3;"><h1 style="font-family: 'Cabin', sans-serif; color: #c3c3c3; font-size: 32px;"><span style="font-size: 48px; font-family: Georgia, sans-serif; color: #ecf0f1;">
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#660066;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-size: 24px;">LOG IN MENU</span></p></div>
      ...
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
        <tr>
          <td align="center"  role="presentation" style="border:none;border-radius:24px;cursor:auto;mso-padding-alt:9px 26px 9px 26px;" valign="middle">
              ...
              <form action="EmployeeController" method="post">     
                 ...
                 <label for='employeeID'>Employee ID: </label></div>
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;text-align: center"><span style="font-size: 14px;">                
                 <input type='text' name='employeeID' id='employeeID'></span></p></div>
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;text-align: center"><span style="font-size: 14px;">
                  <label for='employeePassword'>Password: </label></div>
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;text-align: center"><span style="font-size: 14px;">
                  <input type='password' name='employeePassword' id='employeePassword'></span></p></div>
    
              <input style="font-size: 15px; display: inline-block; background: #ff99cc; color: #ffffff; font-family: Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif; font-size: 13px; font-weight: normal; line-height: 100%; margin: 0; text-decoration: none; text-transform: none; padding: 9px 26px 9px 26px; mso-padding-alt: 0px; border-radius: 24px; cursor: pointer;" type="submit" name="submit" value="LOG IN">
             </form>  
